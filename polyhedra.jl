...
md"""
A polyhedron is basically like a game die but with a weird shape. The [Polyhedra.jl](https://github.com/JuliaPolyhedra/Polyhedra.jl) package is very useful to work with such objects.
"""
