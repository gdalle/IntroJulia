...
# ╔═╡ ba920604-1811-4c3e-9330-275ee05a1fa3
randname(n) = rand('A':'Z') * join(rand('a':'z', n-1))

# ╔═╡ fb279293-8285-496b-a036-52deab148d02
fieldsvec(obj::T) where {T} = [getfield(obj, name) for name in fieldnames(T)]

# ╔═╡ 685bcfb7-ba8b-448d-bb1b-fede9e36a150
...
# ╔═╡ 90e38f5d-10ee-4ea1-8d56-8598604b2094
...
# ╔═╡ 200f2098-c434-4b58-8c10-52b190421084
...
md"""
!!! warning "Enable type inference"
	Every must be inferrable before running the code, using only the type of the inputs.
"""

# ╔═╡ 49f452c5-e8fc-4f8d-a2ea-046ab3e0dbba
md"""
!!! warning "Reduce memory allocations"
...
ProfileCanvas.@profview profile_test(1000)
...
ProfileCanvas.@profview_allocs profile_test(1000)
...
SplitTwoColumn(
	md"""
!!! info "Group 1"
	Write the slowest _reasonable_ implementation of gradient descent for linear regression that you can think of.
	""",
	md"""
!!! info "Group 2"
	Write the slowest _reasonable_ implementation of gradient descent for linear regression that you can think of.
...
# ╔═╡ 670b3162-5d2d-4771-be52-041c5c38d6f8
md"""
### Group 1
"""

# ╔═╡ ef5c3167-f00d-4a0c-912c-73a9be357241
function descent1

end

# ╔═╡ dadf4a4b-63df-4fe1-bda3-f61c53f0f298
md"""
### Group 2
"""

# ╔═╡ 1938a0cc-bae9-4fa3-8591-883388454299
function descent2

end

# ╔═╡ 4e12e093-e5bb-4921-a335-c0d31c453fa1
md"""
## Improvement
"""

# ╔═╡ 55333113-b7ce-4e7c-ae17-0b8105b1df92
md"""
From now on, you cannot change the code of your initial function
"""

# ╔═╡ 51eeb78e-65d9-458d-b1d2-e6fd376d934c
SplitTwoColumn(
	md"""
!!! danger "Group 1"
	Diagnose the performance issues of `descent1`
	""",
	md"""
!!! danger "Group 2"
	Diagnose the performance issues of `descent2`
	"""
)

# ╔═╡ efbeafd7-1d09-400f-bd53-e23049d17883
md"""
### Group 1
"""

# ╔═╡ 4a2af7d6-a0d9-4897-9960-110491c19eba
md"""
### Group 2
"""
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "6126cd90ee9047b121fb615e700c35d054c59fc9"
