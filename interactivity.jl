...
# ╔═╡ 9b33bfd6-5f6e-11ee-2e87-95b559169392
begin
	using Plots
	using PlutoUI
...
# ╔═╡ 985d1932-b58b-46e5-a623-26fb79827707
TableOfContents()

# ╔═╡ 1ad819c2-15b9-4a51-aabf-43f6cc26a3de
md"""
# Interactive polling
"""

# ╔═╡ 657af9d8-5af5-4f10-9022-0ec823ec8ced
md"""
## Utils
"""

# ╔═╡ 91dba3b4-5721-410e-875f-6392ee41a672
randname(n) = rand('A':'Z') * join(rand('a':'z', n-1))

# ╔═╡ df2dd44a-d778-4106-86f8-b9c8ccfdd515
fieldsvec(obj::T) where {T} = [getfield(obj, name) for name in fieldnames(T)]

# ╔═╡ 5c03e8fe-5637-4961-b064-93eebdeaed33
...
# ╔═╡ 2a959431-0b79-4423-bb9e-e81b75bc1d0b
...
# ╔═╡ 20d3cb52-d709-41ce-971f-04e65ba7b896
...
# ╔═╡ 545ab109-6295-469e-8df1-01c49b78634b
md"""
## Names
"""

# ╔═╡ 426da1c4-32e9-4d86-90df-b4d705d3fe20
@bind nb_students confirm(NumberField(1:50, default=10))

# ╔═╡ 8b687550-7e2f-48e1-8430-7810ba1d2d0a
@bind names_obj poll(
	"Student " .* string.(1:nb_students),
	() -> TextField(default=randname(10))
)

# ╔═╡ 7c7df57f-fd99-44fd-bbfb-befdbfea19ea
names = filter(!(isempty), fieldsvec(names_obj))

# ╔═╡ ec6c7300-ec3d-4b72-9a8c-fd11ad5e957c
md"""
## Multiple choice question
"""

# ╔═╡ d16a497b-f00f-4bbf-8cf4-bc1bd00324f4
md"""
**What is your favorite fruit?**
"""

# ╔═╡ 079c416c-e0a7-4ef0-98d7-c74b9eb24f87
@bind fruits_obj poll(names, () -> Select(["apple", "banana", "strawberry"]))

# ╔═╡ 95fcfa4b-fa31-4322-84cc-7a673932d5d0
begin
	fruits = fieldsvec(fruits_obj)
	plot_counts(fruits)
end

# ╔═╡ 0929e204-50aa-472c-b0cd-433b28b09a45
md"""
## Quantitative question
"""

# ╔═╡ 39e8ee8c-ff08-4551-8004-938245b5e596
@bind estimates_obj poll(names, () -> Slider(0:10, default=5, show_value=true))

# ╔═╡ 497e76ed-2143-4a83-88f9-3d76aa5ca4c6
begin
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "4e4b5d060af603d2d7469d9bd36f48a17edd0d84"
